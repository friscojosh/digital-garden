...
Crypto is harmful to the environment because crypto [mining](mining.md) has a huge environmental footprint. The design of the [Proof of Work](proof-of-work.md) (PoW) [consensus algorithm](consensus-algorithm.md) is energy wasteful as part of its design. 
...
Bitcoin [mining](mining.md) **is** enormously harmful to the environment. There are three factors that give rise to its inordinate environmental footprint which is incommensurate with its generated utility.
...
3. Opportunity cost of the energy used to run [consensus algorithm](consensus-algorithm.md) compared to more efficient [real time gross settlement systems](rtgs.md) and traditional payment rails such as SWIFT, SEPA, Visa and ACH.
