...
Crypto asset [market making](market-maker.md) is subject to extreme forms of [market manipulation](market-manipulation.md) not found in other regulated markets. The [price formation](price-formation.md) of crypto assets is untethered to any [fundamental value](fundamental-value.md) and instead depends purely on the [greater fool theory](greater-fool-theory.md). 

The price setting by crypto exchanges and [order book](order-book.md) design admits extreme forms of [asymmetric information](asymmetric-information.md) which privileges an [economic cartel](cartel.md) who can manipulate crypto assets to extract wealth from public from unfair market making.
...
Crypto assets are thus a form of predatory finance with negative [expected-return](expected-return.md) much like [gambling](gambling.md) in a rigged casino.
