...
- [[Blockchains solve almost no real world problems]]. And to the extent that blockchain-based solutions [[In search of a real world crypto use case|attempt to solve a problem]], it turns out that [[blockchain is inferior and more expensive]] than what we already have.
